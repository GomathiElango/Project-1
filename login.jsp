...
<body>
<h1 style="font-family:Comic Sans MS;"><center><font color="gold">LOGIN</font></center></h1>
<form action="/action_page.php">
    <div class="container">
    <label><center><font color="silver"><b>Username</b></font></center></label>
    <center><input type="text" placeholder="Enter Username" name="uname" required></center><br>
    <label><center><font color="silver"><b>Password</b></font></center></label>
   ...
   <center><button type="submit">Login</button></center><br>
    <input type="checkbox" checked="checked"><font color="pink"> Remember me</font>
  </div>
